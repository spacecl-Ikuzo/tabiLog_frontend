...
const DetailPage = () => {
  ...
  const planDetails = {
    ...
    123: {
      ...
      description: 'ネオ・ルネサンス様式の名建築。作品世界を感じる"雰囲気聖地"。',
      author: 'アニメ巡礼編集部',
    ...
    124: {
      ...
      contentTitle: '天保山大観覧車の基本情報',
      spots: ['観覧車からの夜景', '花火と観覧車の演出', '大阪港エリア'],
      content:
  ...
  const plan = planDetails[planId as keyof typeof planDetails] || planDetails[103];
