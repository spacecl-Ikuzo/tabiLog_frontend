...
const DetailPage = () => {
  ...
  const planDetails = {
    ...
    31: {
      ...
      content:
        '【Day1｜札幌→網走（特急）】<br>早朝に札幌駅発の特急で網走へ。石北本線の冬景色を楽しみつつ約5時間。<br><br>【流氷砕氷船クルーズ】<br>網走港発の砕氷船で約60分のクルーズ。1月下旬〜3月下旬運航（天候により変動）。<br><br>【網走湖荘ホテル温泉】<br>湖畔の温泉宿で一息。夕食はオホーツクの海の幸を。<br><br>【季節列車で北浜駅へ】<br>流氷シーズンに合わせた臨時列車で海沿いの絶景を満喫。<br><br>【Day2｜網走散策→札幌へ】<br>天都山展望台や流氷展望台を巡って、午後の特急で札幌へ戻ります。',
    },
    24: {
