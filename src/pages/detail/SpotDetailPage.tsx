...
const SPOT_DETAILS: Record<string, Record<string, SpotDetail>> = {
  ...
  京都: {
    ...
    '36': {
      ...
      author: 'タビログ編集部',
      heroImage: Kyoto_UjiBridge1,
      breadcrumb: ['京都', '宇治市', '宇治橋'],
      contentTitle: '宇治橋の基本情報',
      spots: ['宇治橋の絶景', '源氏物語の世界', '宇治川の風景'],
      imageLeft: Kyoto_UjiBridge1,
      imageRight: KyotoKinkakuji2,
      content:
        '宇治橋は宇治川に架かる歴史ある橋で、日本三大古橋の一つとして知られています。源氏物語の舞台としても有名で、紫式部の物語の世界を感じることができます。橋からは宇治川の美しい流れと周辺の自然景観を望むことができ、特に春の桜や秋の紅葉の季節は絶景スポットとなります。<br><br>【2.1 宇治橋の絶景】<br>橋の上からは宇治川の清らかな流れと四季折々の美しい景色を楽しむことができます。<br><br>【2.2 源氏物語の世界】<br>源氏物語宇治十帖の舞台として、平安時代の雅な文化を感じることができる歴史的スポットです。<br><br>【2.3 宇治川の風景】<br>宇治川沿いの風景は一年を通して美しく、散策やカメラ撮影に最適な場所です。',
    },
    '37': {
      title: '🏛️ 平等院鳳凰堂',
      description: '世界遺産の寺院。10円硬貨のデザインで有名',
      author: 'タビログ編集部',
      heroImage: Kyoto_Byodoin,
      breadcrumb: ['京都', '宇治市', '平等院鳳凰堂'],
      contentTitle: '平等院鳳凰堂の基本情報',
      spots: ['鳳凰堂の建築美', '阿弥陀如来坐像', '浄土式庭園'],
      imageLeft: Kyoto_Byodoin,
      imageRight: KyotoKinkakuji3,
      content:
        '平等院鳳凰堂は1053年に建立された世界文化遺産の寺院で、10円硬貨のデザインでも親しまれています。藤原頼通によって建てられたこの建物は、平安時代の浄土教建築の傑作とされ、極楽浄土を地上に表現した美しい建築として知られています。<br><br>【2.1 鳳凰堂の建築美】<br>翼を広げた鳳凰のような美しいシルエットが特徴的で、その優雅な姿は平安時代の美意識を物語っています。<br><br>【2.2 阿弥陀如来坐像】<br>堂内に安置された阿弥陀如来坐像は国宝に指定されており、平安時代の仏教美術の最高傑作の一つです。<br><br>【2.3 浄土式庭園】<br>建物を囲む庭園は極楽浄土を表現しており、特に池に映る鳳凰堂の姿は絶景です。',
    },
    '38': {
      title: '⛩️ 伏見稲荷大社',
      ...
      author: 'タビログ編集部',
      heroImage: KyotoHero,
      breadcrumb: ['京都', '伏見区', '伏見稲荷大社'],
      contentTitle: '伏見稲荷大社の基本情報',
      spots: ['千本鳥居', '稲荷山ハイキング', '狐の石像'],
      imageLeft: KyotoKinkakuji1,
      imageRight: KyotoKinkakuji2,
      content:
        '伏見稲荷大社は全国に約3万社ある稲荷神社の総本宮で、特に千本鳥居で有名です。朱色の鳥居が稲荷山の山頂まで約4km続く光景は圧巻で、外国人観光客にも人気の高いスポットです。商売繁盛・五穀豊穣の神として信仰を集めています。<br><br>【2.1 千本鳥居】<br>数千本の朱色の鳥居がトンネルのように連なる神秘的な光景は、京都観光のハイライトの一つです。<br><br>【2.2 稲荷山ハイキング】<br>鳥居をくぐりながら稲荷山を登るハイキングコースは、約2時間で山頂まで到達できます。<br><br>【2.3 狐の石像】<br>境内には稲荷神の使いである狐の石像が数多く配置されており、それぞれ異なる表情を見せています。',
    },
    '39': {
      title: '🎋 嵐山・竹林の小径',
      ...
      breadcrumb: ['京都', '嵐山', '竹林の小径'],
      contentTitle: '竹林の小径の基本情報',
      spots: ['竹林のトンネル', '天龍寺との組み合わせ', '嵐山散策'],
      imageLeft: TogetsukyoBridge5,
      imageRight: KyotoKinkakuji3,
      content:
        '嵐山の竹林の小径は、数万本の竹が作り出す幻想的な緑のトンネルで知られる京都の人気観光スポットです。天龍寺の北側から野宮神社まで続く約400mの散策路で、風に揺れる竹の音「竹風の音」は日本の音風景100選にも選ばれています。<br><br>【2.1 竹林のトンネル】<br>高さ10m以上の竹が作り出す緑のトンネルは、まさに別世界のような美しさです。<br><br>【2.2 天龍寺との組み合わせ】<br>隣接する世界遺産・天龍寺の庭園と合わせて訪れることで、より充実した京都観光を楽しめます。<br><br>【2.3 嵐山散策】<br>渡月橋や嵐山公園など、周辺の観光スポットと合わせた散策コースがおすすめです。',
    },
  },
  札幌: {
    '7': {
